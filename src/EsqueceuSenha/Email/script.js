...
const formMudancaSenha = document.querySelector('#form-mudanca-senha');
...
// Serve como base de como seria se  app funcionase no codigo
btnVerificar.addEventListener('click', function() {
    const codigo = document.querySelector('#codigo').value;
    if (codigo === '123456') {
        formCodigo.style.display = 'none';
        formMudancaSenha.style.display = 'block';
    }
});
